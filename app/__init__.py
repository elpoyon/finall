...
def create_app():
    ...
    from app.routes import clientes_routes , conductores_routes, destinos_routes, origenes_routes, mercancias_routes, TMercancias_routes, vehiculos_routes, ordenes_routes, index_routes, index1_routes, auth_routes
    ...
    from app.routes.Json import users_route, vehiculos_route, conductores_route
